  ...
  return (
    <section className="py-24 bg-brand-black border-y border-brand-border/50 relative overflow-hidden">
      ...
      <div className="flex relative overflow-hidden group">
          ...
          {[...partners, ...partners, ...partners].map((partner, index) => (
            ...
            >
              <img 
                ...
                className="h-7 md:h-10 w-auto object-contain logo-white-filter"
                loading="lazy"
              />
            </div>
          ))}
        ...
        {/* Gradient Masks */}
        <div className="absolute left-0 top-0 bottom-0 w-48 bg-gradient-to-r from-brand-black via-brand-black/90 to-transparent z-10 pointer-events-none"></div>
        <div className="absolute right-0 top-0 bottom-0 w-48 bg-gradient-to-l from-brand-black via-brand-black/90 to-transparent z-10 pointer-events-none"></div>
      </div>
    </section>
  );
};
